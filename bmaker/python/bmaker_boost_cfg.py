###########################################################
### Configuration file to make boost babies from miniAOD
###########################################################
import math, sys
...
if outName == "output.root": # output filename not set
    rootfile = basename(options.inputFiles[0].strip("file:"))
...
process.baby_boost = cms.EDAnalyzer('bmaker_boost',
...
if doJEC:
    ...
    if not fastsim:
        ...
        process.p = cms.Path(process.baby_boost)
