// Creates baby tree with heller branches

#ifndef H_BMAKER_HELLER
#define H_BMAKER_HELLER
...
// Class declaration
class bmaker_heller : public edm::EDAnalyzer {
public:
  explicit bmaker_heller(const edm::ParameterSet&);
  ~bmaker_heller();
