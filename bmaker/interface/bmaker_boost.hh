// Creates baby tree with boost branches

#ifndef H_BMAKER_BOOST
#define H_BMAKER_BOOST
...
// Class declaration
class bmaker_boost : public edm::EDAnalyzer {
public:
  explicit bmaker_boost(const edm::ParameterSet&);
  ~bmaker_boost();
