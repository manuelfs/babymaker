...
double pxA = 179.52; // x momentum of visible object on side A.
double pyA = -19.815; // y momentum of visible object on side A.

double mVisB = 0; // mass of visible object on side B.  Must be >=0.
double pxB = -8.435; // x momentum of visible object on side B.
double pyB = 13.652; // y momentum of visible object on side B.

double pxMiss = -188.19; // x component of missing transverse momentum.
double pyMiss = 188.28; // y component of missing transverse momentum.
...
//event 5662...
 double mVisA = 0; // mass of visible object on side A.  Must be >=0.
 double pxA = 55.6; // x momentum of visible object on side A.
 double pyA = 49.76; // y momentum of visible object on side A.
 
 double mVisB = 0; // mass of visible object on side B.  Must be >=0.
 double pxB = -12.5; // x momentum of visible object on side B.
 double pyB = -14.5; // y momentum of visible object on side B.
 
 double pxMiss = -264; // x component of missing transverse momentum.
 double pyMiss = -378; // y component of missing transverse momentum.
...
double desiredPrecisionOnMt2 = 0; // Must be >=0.  If 0 alg aims for machine precision.  if >0, MT2 computed to supplied absolute precision.
 ...
 //event 1827...
 double mVisA = 0; // mass of visible object on side A.  Must be >=0.
 double pxA = -174.96; // x momentum of visible object on side A.
 double pyA = 105; // y momentum of visible object on side A.
 
 double mVisB = 0; // mass of visible object on side B.  Must be >=0.
 double pxB = 42.707; // x momentum of visible object on side B.
 double pyB = -6.4748; // y momentum of visible object on side B.
 
 double pxMiss = 429.9; // x component of missing transverse momentum.
 double pyMiss = -111.5; // y component of missing transverse momentum.
